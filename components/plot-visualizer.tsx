    ...
    >
      ...
      {rowYs.length >= 2 && aisleWidthIn > 0 && (
        <g>
          ...
          <text
            x={PAD + plotW + 18}
            y={(PAD + rowYs[0] + defaultBedHeightPx / 2 + PAD + rowYs[1] - defaultBedHeightPx / 2) / 2 + 3}
            textAnchor="middle" fontSize={7} fill="#6b4c28"
            transform={`rotate(-90, ${PAD + plotW + 18}, ${(PAD + rowYs[0] + defaultBedHeightPx / 2 + PAD + rowYs[1] - defaultBedHeightPx / 2) / 2})`}
          >
